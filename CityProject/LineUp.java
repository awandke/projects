...
public class LineUp extends Applet
{
   ...
   public void init ()
   {
      ...
      figure1 = new StickFigure (50, 150, Color.red, h1);
      figure2 = new StickFigure (100, 150, Color.blue, h2);
      figure3 = new StickFigure (150, 150, Color.green, h3);
      figure4 = new StickFigure (200, 150, Color.yellow, h4);
